...
#define LTE_NUM_OF_SSS_SYMBOL           2
#define LTE_NUM_OF_CELL_ID              3

#define LIBLTE_NUM_OF_CELL_GROUP_ID     168
#define LIBLTE_NUM_OF_PSS_SEQUENCE      62
#define LIBLTE_NUM_OF_SSS_SEQUENCE      62

#define LTE_NUM_OF_NID                  (LTE_NUM_OF_CELL_ID * LIBLTE_NUM_OF_CELL_GROUP_ID)
...
#define LIBLTE_PHY_PDCCH_MAX_ALLOC      64

#define LIBLTE_PRINT_ITEM_PER_LINE      (20)
#define ITEM_PER_LINE                   10
#define PSS_SEQ_LENGTH                  62
#define SSS_SEQ_LENGTH                  (62)

#define NUM_OF_SEARCH_FRAME                 2
#define SEARCH_CUT_OFF_CORRELATION_RATIO    0.5
#define PSS_POWER_MAX_TO_THRESHOLD_RATIO    0.8

#define SSS_SYMBOL_NUM                      5
#define PSS_SYMBOL_NUM                      6
#define NUM_OF_SUBFRAME_PER_PSS_PERIOD      5
#define NUM_OF_SUBFRAME_PER_SSS_PERIOD      5
#define SEARCH_COARSE_LIMIT                 10
#define SEARCH_FINE_LIMIT                   40


#define PSS_FINE_SEARCH_LENGTH              80
#define NUM_OF_MAX_SEARCH_PSS_CORR_PEAK     64

#define SSS_TO_PSS_THRESHOLD                0.9
#define SEARCH_SSS_LIMIT                    40
#define _ARRAY_SIZE_(x)  (sizeof(x)/sizeof(x[0]))
#define MAX_AGGREGATION_LEVEL                   8
#define N_CCE_OF_COMMON_SEARCH_SPACE            16
#define N_CCE_OF_USER_SPECIFIC_SEARCH_SPACE     16
...
static const char *liblte_phy_pre_coder_type_text[2] = {"Tx Diversity", "Spatial multiplexing"};
...
typedef enum{
    ...
    LIBLTE_PHY_MODULATION_TYPE_ITEM
}LIBLTE_PHY_MODULATION_TYPE_ENUM;
static const char *liblte_phy_modulation_type_text[4] = {"BPSK", "QPSK", "16QAM", "64QAM"};
...
static const char *liblte_phy_chan_type_text[4] = {"DLSCH", "PCH", "ULSCH", "ULCCH"};
...
typedef struct{
    ...
    int tx_symb[LIBLTE_PHY_N_ANT_MAX][16][LIBLTE_PHY_N_RB_DL_20MHZ*LIBLTE_PHY_N_SC_RB_DL_NORMAL_CP];
...
typedef struct{
    ...
    float pss_mod_re_n[3][3][LIBLTE_PHY_N_RB_DL_20MHZ*LIBLTE_PHY_N_SC_RB_DL_NORMAL_CP];
    float pss_mod_im_n[3][3][LIBLTE_PHY_N_RB_DL_20MHZ*LIBLTE_PHY_N_SC_RB_DL_NORMAL_CP];

    // SSS
    float sss_mod_re_0[LTE_NUM_OF_NID][LIBLTE_PHY_N_RB_DL_20MHZ*LIBLTE_PHY_N_SC_RB_DL_NORMAL_CP];
    float sss_mod_im_0[LTE_NUM_OF_NID][LIBLTE_PHY_N_RB_DL_20MHZ*LIBLTE_PHY_N_SC_RB_DL_NORMAL_CP];
    float sss_mod_re_5[LTE_NUM_OF_NID][LIBLTE_PHY_N_RB_DL_20MHZ*LIBLTE_PHY_N_SC_RB_DL_NORMAL_CP];
    float sss_mod_im_5[LTE_NUM_OF_NID][LIBLTE_PHY_N_RB_DL_20MHZ*LIBLTE_PHY_N_SC_RB_DL_NORMAL_CP];

    float sss_sample_re_0[LTE_NUM_OF_NID][LIBLTE_PHY_N_SAMPS_PER_SYMB_30_72MHZ+LIBLTE_PHY_N_SAMPS_CP_L_ELSE_30_72MHZ];
    float sss_sample_im_0[LTE_NUM_OF_NID][LIBLTE_PHY_N_SAMPS_PER_SYMB_30_72MHZ+LIBLTE_PHY_N_SAMPS_CP_L_ELSE_30_72MHZ];
    float sss_sample_re_5[LTE_NUM_OF_NID][LIBLTE_PHY_N_SAMPS_PER_SYMB_30_72MHZ+LIBLTE_PHY_N_SAMPS_CP_L_ELSE_30_72MHZ];
    float sss_sample_im_5[LTE_NUM_OF_NID][LIBLTE_PHY_N_SAMPS_PER_SYMB_30_72MHZ+LIBLTE_PHY_N_SAMPS_CP_L_ELSE_30_72MHZ];
    ...
    float  bch_mod_sym_re[4][480];
    float  bch_mod_sym_im[4][480];    
    int32_t bch_n_mod_sym[4];
    int32_t bch_mod_antenna;

    float  pdcch_mod_sym_re[LIBLTE_PHY_PDCCH_MAX_ALLOC][LIBLTE_PHY_PDCCH_N_BITS_MAX];
    float  pdcch_mod_sym_im[LIBLTE_PHY_PDCCH_MAX_ALLOC][LIBLTE_PHY_PDCCH_N_BITS_MAX];
    int32_t pdcch_mod_type[LIBLTE_PHY_PDCCH_MAX_ALLOC];
    int32_t pdcch_n_mod_sym[LIBLTE_PHY_PDCCH_MAX_ALLOC];
    int32_t pdcch_alloc;

    uint16_t pdcch_cce_allocated;
    uint16_t pdcch_cce_alloc_type[LIBLTE_PHY_PDCCH_N_CCE_MAX];
    uint16_t pdcch_cce_start_index[LIBLTE_PHY_PDCCH_N_CCE_MAX];
    uint16_t pdcch_cce_rnti[LIBLTE_PHY_PDCCH_N_CCE_MAX];
    uint16_t pdcch_cce_agg_level[LIBLTE_PHY_PDCCH_N_CCE_MAX];
    uint16_t pdcch_dci_format[LIBLTE_PHY_PDCCH_N_CCE_MAX];
    uint16_t pdcch_dci_len[LIBLTE_PHY_PDCCH_N_CCE_MAX];    
    
    float  pdsch_mod_sym_re[10000];
    float  pdsch_mod_sym_im[10000];    
    int32_t pdsch_n_mod_sym;    
    int32_t pdsch_mod_type;    
    
    // Timing
    float pss_sample_re[LTE_NUM_OF_CELL_ID][LIBLTE_PHY_N_SAMPS_CP_L_ELSE_30_72MHZ + LIBLTE_PHY_N_SAMPS_PER_SYMB_30_72MHZ];
    float pss_sample_im[LTE_NUM_OF_CELL_ID][LIBLTE_PHY_N_SAMPS_CP_L_ELSE_30_72MHZ + LIBLTE_PHY_N_SAMPS_PER_SYMB_30_72MHZ];

    float sss_sample_re[LTE_NUM_OF_CELL_ID][LIBLTE_NUM_OF_CELL_GROUP_ID][LTE_NUM_OF_SSS_SYMBOL][LIBLTE_PHY_N_SAMPS_CP_L_ELSE_30_72MHZ + LIBLTE_PHY_N_SAMPS_PER_SYMB_30_72MHZ];
    float sss_sample_im[LTE_NUM_OF_CELL_ID][LIBLTE_NUM_OF_CELL_GROUP_ID][LTE_NUM_OF_SSS_SYMBOL][LIBLTE_PHY_N_SAMPS_CP_L_ELSE_30_72MHZ + LIBLTE_PHY_N_SAMPS_PER_SYMB_30_72MHZ];
    
    float dl_timing_cross_corr[LTE_NUM_OF_CELL_ID][LIBLTE_PHY_N_SAMPS_PER_FRAME_30_72MHZ * NUM_OF_SEARCH_FRAME];
...
static const char liblte_phy_dci_ca_presence_ext[LIBLTE_PHY_TPC_COMMAND_DCI_0_3_4_N_ITEMS][20] = {"CA Not Present", "CA Present"};
...
#define LIBLTE_PHY_CORSE_SCAN_STEP                  16
...
typedef struct {
    ...
    int32  nid2[LIBLTE_PHY_N_MAX_ROUGH_CORR_SEARCH_PEAKS];
    float abs_corr[LIBLTE_PHY_N_MAX_ROUGH_CORR_SEARCH_PEAKS];    
    int32_t abs_corr_idx[LIBLTE_PHY_N_MAX_ROUGH_CORR_SEARCH_PEAKS];
    uint32 n_corr_peaks;    
