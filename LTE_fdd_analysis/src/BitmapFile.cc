...
/** @addtogroup BITMAPFILE
  * @{
  */
/* Private macros ------------------------------------------------------------*/
/** @addtogroup BITMAPFILE_Private_Macros
  * @{
  */
...
/* Private types -------------------------------------------------------------*/
/** @addtogroup BITMAPFILE_Private_Types
  * @{
  */
...
/** @addtogroup BITMAPFILE_Private_Functions
  * @{
  */
...
/* Private variables ---------------------------------------------------------*/
/** @addtogroup BITMAPFILE_Private_Variables
  * @{
  */
...
/* Exported variables ---------------------------------------------------------*/
/** @addtogroup BITMAPFILE_Exported_Variables
  * @{
  */
...
/* Exported functions ---------------------------------------------------------*/
/** @addtogroup BITMAPFILE_Exported_Functions
  * @{
  */
